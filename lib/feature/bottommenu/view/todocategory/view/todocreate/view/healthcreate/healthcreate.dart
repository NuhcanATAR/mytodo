...
// view routers
import 'package:mytodo/feature/bottommenu/view/todocategory/view/todocreate/view/healthcreate/widget/titlesubtitle_widget.dart';
...
class _HealthCreateViewState extends MainTodoBase<HealthCreateView> {
  @override
        ...
        children: <Widget>[
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              isExpanded: true,
              value: serviceModel.healtCategorySelect,
              icon: const Icon(
              ...
              onChanged: (String? value) {
                setState(() {
                  serviceModel.healtCategorySelect = value!;
                });
              },
              style: GoogleFonts.nunito(
                textStyle: context.general.textTheme.labelMedium?.copyWith(
