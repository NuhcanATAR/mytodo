...
// view routers
import 'package:mytodo/feature/bottommenu/view/todocategory/view/todocreate/view/moviecreate/widget/titlesubtitle_widget.dart';
...
class _MovieCreateViewState extends MainTodoBase<MovieCreateView> {
  @override
          ...
          children: <Widget>[
            ...
            DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                isExpanded: true,
                value: serviceModel.movieCategorySelect,
                icon: const Icon(
                  Icons.movie,
                ...
                onChanged: (String? value) {
                  setState(() {
                    serviceModel.movieCategorySelect = value!;
                  });
                },
                style: GoogleFonts.nunito(
                  textStyle: context.general.textTheme.labelMedium?.copyWith(
