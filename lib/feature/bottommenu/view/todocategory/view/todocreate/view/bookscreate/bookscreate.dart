...
// view routers
import 'package:mytodo/feature/bottommenu/view/todocategory/view/todocreate/view/bookscreate/widget/titlesubtitle_widget.dart';
...
class BooksCreateView extends StatefulWidget {
  const BooksCreateView({super.key, required this.data});
  final Map<String, dynamic> data;

  @override
  State<BooksCreateView> createState() => _BooksCreateViewState();
}

class _BooksCreateViewState extends MainTodoBase<BooksCreateView> {
  @override
            ...
            Row(
              children: <Widget>[
                ...
                LabelMediumBlackBoldText(
                  ...
                  text: serviceModel.bookPageCount.toString(),
                ),
                // +
                GestureDetector(
                  onTap: () {
        ...
        children: <Widget>[
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              isExpanded: true,
              value: serviceModel.bookCategorySelect,
              icon: const Icon(
                Icons.book,
              ...
              onChanged: (String? value) {
                setState(() {
                  serviceModel.bookCategorySelect = value!;
                });
              },
              style: GoogleFonts.nunito(
                textStyle: context.general.textTheme.labelMedium?.copyWith(
